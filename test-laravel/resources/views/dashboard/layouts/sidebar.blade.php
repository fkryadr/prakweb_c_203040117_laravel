<div class="px-4 py-2 bg-gray-200 bg-blue-900 lg:w-1/4">
    ...
    <div class="hidden lg:block">
        <div class="my-2 mb-6">
            <h1 class="text-2xl font-bold text-white">Ma Dashboard</h1>
        </div>
        <ul>
            <li class="mb-6">
                <div class="relative">
            ...
            <li class="mb-2 bg-gray-800 rounded shadow">
                <a href="/dashboard/posts" class="inline-block w-full h-full px-3 py-2 font-bold text-white">
                    <svg xmlns="http://www.w3.org/2000/svg" class="inline-block w-6 h-6 mr-2 -mt-2"
